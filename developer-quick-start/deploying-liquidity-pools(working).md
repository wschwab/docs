...
The first step will be connecting with the `ConverterRegistry` contract. In order to get the current address of the `ConverterRegistry` you can query the `ContractRegistry`. The following snippet will provide Converter Registry address.
...
We'll describe how to use this function from inside a smart contract, and also using Web3 libraries.
